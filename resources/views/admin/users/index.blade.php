                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            <a href="{{route('voyager.user.wallet',['id'=>$data->id])}}" title="Xóa"
                                               class="btn btn-sm btn-success pull-right" style="margin-left: 5px">
                                                <i class="voyager-wallet"></i> <span
                                                    class="hidden-xs hidden-sm">{{__('wallet.self')}}</span>
                                            </a>
                                            @foreach($actions as $action)
                                                @if (!method_exists($action, 'massAction'))
